    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash("Unfortunately, You don't have enough money to purchase this product!", category='danger')
        # sell Item logic:
...
def login_page():
    ...
    if form.validate_on_submit():
        ...
        if attempted_user and attempted_user.check_password_correction(
            ...
            flash('User name or password are not matched! Please try again', category='danger')
